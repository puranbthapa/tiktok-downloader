...
<?php $__env->startSection('title', 'YouTube Video Downloader - Download YouTube Videos in HD, 4K'); ?>
<?php $__env->startSection('meta_description', 'Download YouTube videos and shorts in HD, Full HD, and 4K quality. Free YouTube video downloader with multiple format options. No registration required.'); ?>
<?php $__env->startSection('meta_keywords', 'youtube downloader, youtube video downloader, download youtube videos, youtube to mp4, youtube downloader hd, youtube shorts downloader, save youtube videos'); ?>
...
<div class="w-full">
    ...
    <form action="<?php echo e(route('youtube.download')); ?>" method="POST" class="mb-6">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="bg-gray-800 rounded-2xl overflow-hidden border border-gray-700">
        ...
        <div class="p-5">
            ...
            <p class="text-gray-400 text-sm mb-4">By: <?php echo e($video['author']); ?> · <?php echo e($video['duration']); ?></p>

            <div class="flex flex-col gap-3">
                
                <?php $__currentLoopData = $video['combined']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fmt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('youtube.stream', ['url' => $fmt['url']])); ?>"
                   class="<?php echo e($loop->first ? 'bg-red-600 hover:bg-red-700' : 'bg-gray-700 hover:bg-gray-600'); ?> text-white text-center font-semibold py-3 rounded-xl transition flex items-center justify-center gap-2">
                    <span>⬇ Download <?php echo e($fmt['quality']); ?></span>
                    <?php if($fmt['size']): ?>
                        <span class="text-xs opacity-70">(<?php echo e($fmt['size']); ?>)</span>
                    <?php endif; ?>
                </a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                
                <?php if(!empty($video['videoOnly'])): ?>
                    ...
                    <?php $__currentLoopData = $video['videoOnly']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fmt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('youtube.stream', ['url' => $fmt['url']])); ?>"
                       class="bg-gray-700 hover:bg-gray-600 text-white text-center font-semibold py-3 rounded-xl transition flex items-center justify-center gap-2">
                        <span>⬇ <?php echo e($fmt['quality']); ?></span>
                        <?php if($fmt['size']): ?>
                            <span class="text-xs opacity-70">(<?php echo e($fmt['size']); ?>)</span>
                        <?php endif; ?>
                    </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\tiktok-downloader\resources\views/youtube/index.blade.php ENDPATH**/ ?>